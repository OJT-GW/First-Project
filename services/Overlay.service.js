import { showElement, hideElement } from "../utils/helpers.util.js";
import {
  getPersonalityByIndex,
  submitPersonalityEdit,
...
export function showEditPersonalityForm(personalityIndex) {
  ...
  editPersonalityForm.querySelector("#personalityNameInput").value =
    personality.name;
  editPersonalityForm.querySelector("#personalityDescriptionInput").value =
    personality.description;
  editPersonalityForm.querySelector("#personalityPromptInput").value =
    personality.prompt;
  editPersonalityForm.querySelector("#personalityImageURLInput").value =
    personality.image;
  editPersonalityForm.querySelector("#personalityIndex").value =
    personalityIndex;
}
...
export function editPersonalityFormSubmit() {
  const personalityJSON = {
    ...
    description: editPersonalityForm.querySelector(
      "#personalityDescriptionInput"
    ).value,
